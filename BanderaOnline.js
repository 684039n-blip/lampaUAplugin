(function () {
    ...
    function CikavaIdeya(component, _object) {
      ...
      function search(title) {
        ...
        url = addParam(url, 'source', 'CikavaIdeya');
      ...
      function loadMovie(href) {
        var url = api_base + '/CikavaIdeya/movie';
      ...
      function loadSeries(href) {
        var url = api_base + '/CikavaIdeya/series';
        url = addParam(url, 'href', href);
        network.silent(url, function (json) {
          if (!json || !json.ok) {
            component.doesNotAnswer();
      ...
      function buildEpisodes() {
        ...
        var url = api_base + '/CikavaIdeya/episodes';
      ...
      function getStream(item, success, fail) {
        var url = api_base + '/CikavaIdeya/stream';
